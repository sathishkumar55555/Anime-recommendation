...
def extract_weights(file_path, layer_name):
    ...
    raise KeyError(f"Unable to find weights for layer")
...
def recommend():
    ...
    if recommendation_type == "user_based":
        ...
        try:
            ...
            return render_template('index.html', error_message="Please enter a valid User ID", recommendation_type=recommendation_type)
        ...
        if similar_user_ids is None or similar_user_ids.empty:
            ...
            if response.status_code == 200:
                ...
                if 'data' not in data:
                    ...
                    message1 = "No anime recommendations available"
            else:
